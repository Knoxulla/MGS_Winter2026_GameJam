...
public class BoundarySystemController : MonoBehaviour
{
    ...
    {
        if(PlayerMASTER.Instance.transform.position.x > (RightWall.position.x - 5))
        {
        ...
        else if (PlayerMASTER.Instance.transform.position.x < (LeftWall.position.x + 5))
        {
        ...
        else if (PlayerMASTER.Instance.transform.position.y > (TopWall.position.y - 5))
        {
        ...
        else if (PlayerMASTER.Instance.transform.position.y < (BottomWall.position.y + 5))
        {
